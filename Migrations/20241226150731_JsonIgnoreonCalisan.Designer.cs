...
namespace SalonYonetimUygulamasi.Migrations
{
    ...
    [Migration("20241226150731_JsonIgnoreonCalisan")]
    partial class JsonIgnoreonCalisan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalonYonetimUygulamasi.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalonYonetimUygulamasi.Models.Randevu", b =>
                {
                    ...
                    b.HasOne("SalonYonetimUygulamasi.Models.Islem", "Islem")
                        .WithMany()
                    ...
                    b.HasOne("SalonYonetimUygulamasi.Models.User", "Kullanici")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
